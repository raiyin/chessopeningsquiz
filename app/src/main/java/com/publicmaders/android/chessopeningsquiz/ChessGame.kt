...
object ChessGame {
    ...
    fun reset() {
        ...
        for (i in 0 until 2) {
            ...
            addPiece(ChessPiece(0 + i * 7, 7, Player.BLACK, Chessman.ROOK, R.drawable.ic_chess_br))

            addPiece(ChessPiece(1 + i * 5, 0, Player.WHITE, Chessman.KNIGHT, R.drawable.ic_chess_wn))
            addPiece(ChessPiece(1 + i * 5, 7, Player.BLACK, Chessman.KNIGHT, R.drawable.ic_chess_bn))

            addPiece(ChessPiece(2 + i * 3, 0, Player.WHITE, Chessman.BISHOP, R.drawable.ic_chess_wb))
            addPiece(ChessPiece(2 + i * 3, 7, Player.BLACK, Chessman.BISHOP, R.drawable.ic_chess_bb))
        }

        for (i in 0 until 8) {
            addPiece(ChessPiece(i, 1, Player.WHITE, Chessman.PAWN, R.drawable.ic_chess_wp))
            addPiece(ChessPiece(i, 6, Player.BLACK, Chessman.PAWN, R.drawable.ic_chess_bp))
        }

        addPiece(ChessPiece(3, 0, Player.WHITE, Chessman.QUEEN, R.drawable.ic_chess_wq))
        addPiece(ChessPiece(3, 7, Player.BLACK, Chessman.QUEEN, R.drawable.ic_chess_bq))
        addPiece(ChessPiece(4, 0, Player.WHITE, Chessman.KING, R.drawable.ic_chess_wk))
